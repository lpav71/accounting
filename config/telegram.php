...
return [
    ...
    */
    'bots'                         => [
        'bot' => [
            ...
            'chat'                =>  env('TELEGRAM_BOT_ORDERS_ALERTS_CHAT', 'YOUR-BOT-CHAT-ID'),
            'commands'            => [
                App\Services\Telegram\Commands\HelpCommand::class,
                App\Services\Telegram\Commands\StartCommand::class,
                App\Services\Telegram\Commands\LoginCommand::class,
                App\Services\Telegram\Commands\LogoutCommand::class,
                App\Services\Telegram\Commands\TicketsCommand::class,
                App\Services\Telegram\Commands\TicketCommand::class,
                App\Services\Telegram\Commands\TicketCreateCommand::class,
                App\Services\Telegram\Commands\TicketCloseCommand::class
            ],
        ],
        'security_bot' => [
            'username'            => env('TELEGRAM_SECURITY_BOT_USERNAME', 'YOUR-BOT-USERNAME'),
            'token'               => env('TELEGRAM_SECURITY_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path'    => env('TELEGRAM_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'chat'                => env('TELEGRAM_SECURITY_BOT_TECHNICAL_CHAT', 'YOUR-BOT-CHAT-ID'),
            'commands'            => [

            ],
        ],
        'accounting_bot' => [
            'username'            => env('TELEGRAM_ACC_BOT_USERNAME', 'YOUR-BOT-USERNAME'),
            'token'               => env('TELEGRAM_ACC_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path'    => env('TELEGRAM_ACC_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('TELEGRAM_ACC_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [

            ],
        ],
        'urgentAl_bot' => [
            'username'            => env('URGENT_AL_BOT_USERNAME', 'YOUR-BOT-USERNAME'),
            'token'               => env('URGENT_AL_BOT_TOKEN', 'YOUR-BOT-TOKEN'),
            'certificate_path'    => env('URGENT_AL_CERTIFICATE_PATH', 'YOUR-CERTIFICATE-PATH'),
            'webhook_url'         => env('URGENT_AL_WEBHOOK_URL', 'YOUR-BOT-WEBHOOK-URL'),
            'commands'            => [
    ...
    */
    ...
    'technical_chat' => env('TELEGRAM_BOT_TECHNICAL_CHAT', 'YOUR-TECHNICAL-CHAT'),
    ...
    */
    ...
    'warnings_chat' => env('TELEGRAM_BOT_WARNINGS_CHAT', 'YOUR-WARNINGS-CHAT'),

     /*
    |--------------------------------------------------------------------------
    | Orders alerts chat id
    |--------------------------------------------------------------------------
    |
    */

    'orders_alerts_chat' => env('TELEGRAM_BOT_ORDERS_ALERTS_CHAT', 'YOUR-ORDERS-ALERTS-CHAT'),
