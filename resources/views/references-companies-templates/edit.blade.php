...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>{{ __('Edit companies template') }}</h2>
            </div>
    ...
    @endif
    {!! Form::model($referencesCompaniesTemplate, ['method' => 'PATCH','route' => ['references-companies-templates.update', $referencesCompaniesTemplate->id]]) !!}
    <div class="row">
        <div class="col-12">
