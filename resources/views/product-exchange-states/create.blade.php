...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>{{ __('Create New Exchange State') }}</h2>
            </div>
    ...
    @endif
    {!! Form::open(['route' => 'product-exchange-states.store','method'=>'POST']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('previous_states_id[]', $exchangeStates, [], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                ...
                {!! Form::select('need_exchange_order_detail_state_id[]', $orderDetailStates, [], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                {!! Form::label('need_one_exchange_order_detail_state_id[]', __('Need One Exchange Order Detail states:')) !!}
                {!! Form::select('need_one_exchange_order_detail_state_id[]', $orderDetailStates, [], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
