...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>{{ __('Create New Task State') }}</h2>
            </div>
    ...
    @endif
    {!! Form::open(['route' => 'task-states.store','method'=>'POST']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('previous_task_states_id[]', $taskStates, [null], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                {!! Form::label('is_new', __('General task state:')) !!}
                {!! Form::checkbox('is_new', 0, null, ['class' => 'form-control selectpicker']) !!}
            </div>
        </div>
