...
@section('content')
    ...
    @endif
    {!! Form::model($carrier, ['method' => 'PATCH','route' => ['carriers.update', $carrier->id]]) !!}
    <div class="row">
        <div class="col-12">
            ...
            <div class="form-group">
                ...
                {!! Form::select('city_id',\App\City::pluck('name','id')->prepend('undefined', 0), isset($carrier->city_id) ? $carrier->city_id : null , [ 'class'=>'form-control']) !!}
            </div><div class="form-group">
                {!! Form::label('carrier_type_id', __('Carrier type'), ['class' => 'form-label']) !!}
                {!! Form::select('carrier_type_id',\App\CarrierType::pluck('name','id'), isset($carrier->carrier_type_id) ? $carrier->carrier_type_id : null , [ 'class'=>'form-control']) !!}
            </div>
            <div class="form-group form-check">
