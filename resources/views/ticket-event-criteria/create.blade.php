...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>{{ __('Create new ticket event criterion') }}</h2>
            </div>
    ...
    {!! Form::open(['route' => 'ticket-event-criteria.store','method'=>'POST']) !!}
    <div class="row">
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="form-group">
                {!! Form::label('message_substring', __('Сообщение содержит')) !!}
                {!! Form::text('message_substring', null, ['placeholder' => __('Сообщение содержит'),'class' => 'form-control']) !!}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                {!! Form::select('weekday_id[]', $weekdays, null, ['multiple','class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
