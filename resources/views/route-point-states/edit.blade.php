...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>{{ __('Edit Route Point State') }}</h2>
            </div>
    ...
    @endif
    {!! Form::model($routePointState, ['route' => ['route-point-states.update', $routePointState->id],'method'=>'PATCH']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('previous_states_id[]', $routePointStates, $routePointState->previousStates->pluck('id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
