...
@section('content')
    ...
    @endif
    {!! Form::model($cashbox, ['method' => 'PATCH','route' => ['cashboxes.update', $cashbox->id]]) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('user_id[]', $users, $cashbox->users()->pluck('user_id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::select('user_id_with_transfer_rights[]', $users, $cashbox->usersWithTransferRights()->pluck('user_id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('user_id_with_confirm_rights[]', __('Users with confirm rights:')) !!}
                {!! Form::select('user_id_with_confirm_rights[]', $users, $cashbox->userWithConfirmedRights()->pluck('user_id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
            <div class="form-group">
