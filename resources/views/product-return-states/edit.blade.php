...
@section('content')
    ...
    @endif
    {!! Form::model($productReturnState, ['route' => ['product-return-states.update', $productReturnState->id],'method'=>'PATCH']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('previous_states_id[]', $returnStates, $productReturnState->previousStates->pluck('id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                ...
                {!! Form::select('need_order_detail_state_id[]', $orderDetailStates, $productReturnState->needOrderDetailStates->pluck('id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                {!! Form::label('need_one_order_detail_state_id[]', __('Need One Order Detail states:')) !!}
                {!! Form::select('need_one_order_detail_state_id[]', $orderDetailStates, $productReturnState->needOneOrderDetailStates->pluck('id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
