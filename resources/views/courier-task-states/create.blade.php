...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-left">
                <h2>{{ __('Create new courier task state') }}</h2>
            </div>
    ...
    @endif
    {!! Form::open(['route' => 'courier-task-states.store','method'=>'POST']) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('previous_states_id[]', $courierTaskStates, [], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
