    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            ...
            <div class="form-group">
                ...
                {!! Form::select('user_id_with_operation_rights[]', $users, [], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
            <div class="form-group">
                {!! Form::label('user_id_with_reservation_rights[]', __('Users with reservation rights:')) !!}
                {!! Form::select('user_id_with_reservation_rights[]', $users, [], ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
            <div class="form-group">
