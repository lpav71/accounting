...
@section('content')
    ...
    {!! Form::open(['route' => 'telegram-report-settings.store','method'=>'POST']) !!}
    <div class="row">
        <div class="col-12">
        ...
        <div class="col-12">
            <div class="form-group">
                ...
                {!! Form::select('task_states[]', $taskStates, null, ['multiple' => true, 'class' => 'form-control form-control-sm selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
                {!! Form::label('order_states[]', __('Order States').':') !!}
                {!! Form::select('order_states[]', $orderStates, null, ['multiple' => true, 'class' => 'form-control form-control-sm selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
                {!! Form::label('order_detail_states[]', __('Order Detail States').':') !!}
                {!! Form::select('order_detail_states[]', $orderDetailStates, null, ['multiple' => true, 'class' => 'form-control form-control-sm selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group">
