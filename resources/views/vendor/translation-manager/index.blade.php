        ...
        <form role="form" method="POST"
            ...
            <div class="form-group">
                ...
                <select name="group" id="group" class="form-control group-select"
                        data-index="{{ action('\Barryvdh\TranslationManager\Controller@getIndex') }}"
                        data-view="{{ action('\Barryvdh\TranslationManager\Controller@getView') }}">
