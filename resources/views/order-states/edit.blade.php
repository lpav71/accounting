...
@section('content')
    ...
    @endif
    {!! Form::model($orderState, ['method' => 'PATCH','route' => ['order-states.update', $orderState->id]]) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('previous_order_states_id[]', $orderStates, $orderState->previousStates()->pluck('order_state_id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-12">
        ...
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                ...
                {!! Form::select('need_order_detail_state_id[]', $orderDetailStates, $orderState->needOrderDetailStates()->pluck('order_detail_state_id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                {!! Form::label('need_one_order_detail_state_id[]', __('Need One Order Detail states:')) !!}
                {!! Form::select('need_one_order_detail_state_id[]', $orderDetailStates, $orderState->needOneOrderDetailStates()->pluck('order_detail_state_id'), ['multiple' => true, 'class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6" data-toggle="is_sending_external_data">
            <div class="form-group">
                {!! Form::label('check_payment', __('Check payment:')) !!}
                {!! Form::select('check_payment', [0 => __('No'), 1 => __('Yes')], null, ['class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6" data-toggle="check_carrier">
            <div class="form-group">
                {!! Form::label('check_carrier', __('Check carrier information')) !!}
                {!! Form::select('check_carrier', [0 => __('No'), 1 => __('Yes')], null, ['class' => 'form-control selectpicker']) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
        ...
        <div class="col-12">
            <div class="form-group form-check">
                {!! Form::checkbox('is_waiting_for_product', 1, null, ['class' => 'form-check-input']) !!}
                {!! Form::label('is_waiting_for_product', __('Waiting for availability'), ['class' => 'form-check-label']) !!}
            </div>
        </div>
        <div class="col-12">
            <div class="form-group form-check">
        ...
        <div class="col-xs-12 col-sm-6">
            <div class="form-group">
                ...
                {!! Form::select('roles[]', \App\Role::all()->pluck('name', 'id'), $orderState->roles()->pluck('role_id'), ['class' => 'form-control selectpicker', 'multiple' => 'true']) !!}
            </div>
        </div>
