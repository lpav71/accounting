 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\ProductReturnState[] $states
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereCarrierId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereComment($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereCreatedAt($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryAddress($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryCity($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryComment($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryEndTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryEstimatedDate($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryFlat($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryPostIndex($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryShippingNumber($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereDeliveryStartTime($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereOrderId($value)
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn whereUpdatedAt($value)
 * @mixin \Eloquent
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn newModelQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn newQuery()
 * @method static \Illuminate\Database\Eloquent\Builder|\App\ProductReturn query()
 */
class ProductReturn extends Model
{
    ...
    {
        return $this
            ->belongsToMany(ProductReturnState::class)
            ->withPivot('created_at')
            ->orderBy('product_return_product_return_state.id', 'desc');
    }
    ...
    /**
     * Проверялась ли оплата по возврату
     *
     * @return bool
     */
    ...
    /**
     * Получение следующего статуса возврата в зависимости от статусов товаров
     *
     * @return mixed
     */
    public function getNextReturnStateDependingOrderDetailStates()
    {
        $states = [];
        /**
    ...
    {
        return !$this->currentState()->inactiveReturn();
    }
}
